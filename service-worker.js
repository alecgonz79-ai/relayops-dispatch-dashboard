const CACHE='relayops-picklist-equipment-icons-v126';
const CORE=[
  './',
  './index.html',
  ...
  './app.js?v=20260914-picklist-equipment-icons-r1',
  ...
  './station-workspace.js?v=20260907-rostering-import-isolation-r1',
