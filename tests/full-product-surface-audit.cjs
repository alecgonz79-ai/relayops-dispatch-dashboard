...
function testVisiblePageInventory() {
  ...
  const inventory = {};
  vm.runInContext("state.adminPinUnlocked=true; state.openingRosterControlsOpen=true; state.morningOperationDate='2026-07-14'; state.driverContacts=[{name:'Andre Wilson',key:'andre wilson'}]; state.morningRoutes=[{dsp:'LLOL',route:'CX101',routeUid:'fixture-route',driver:'Andre Wilson',wave:'11:15 AM',staging:'STG.V.1',service:'Standard Parcel'}];", context);
