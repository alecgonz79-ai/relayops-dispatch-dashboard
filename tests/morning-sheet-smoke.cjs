...
if (!fleetCss.includes('minmax(86px,1fr)') || !fleetCss.includes('min-height:46px') || !fleetCss.includes('width:21px; height:11px') || !fleetCss.includes('.fleet-card-cue')) throw new Error('Tiny EV grid should stay compact and scan-friendly');
