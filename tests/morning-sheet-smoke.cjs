...
const checks = `
  ...
  if(!filteredRoster.includes('Fredy Guerra')||!filteredRoster.includes('1 shown of 4 scheduled')||!filteredRoster.includes('data-schedule-filter')) throw new Error('Paycom shift filter did not isolate matching shifts');
