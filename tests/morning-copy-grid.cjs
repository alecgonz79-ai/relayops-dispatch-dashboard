...
const checks = `
  ...
  if (!testMorningSheetsConnector.toString().includes('A3:M') || !testMorningSheetsConnector.toString().includes('2026-07-10-format-reset') || !testMorningSheetsConnector.toString().includes('Connector deployment is outdated')) throw new Error('Connector test should verify the A3:M range and current formatting-reset deployment build');
