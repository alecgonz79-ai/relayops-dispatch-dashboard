...
class Sheet {
  constructor(name = '7/14/26') { this.name = name; this.values = new Map(); this.maxRows = 125; this.maxCols = 22; this.seedTemplate(); }
  key(r, c) { return `${r}:${c}`; }
  ...
  seedTemplate() {
    ...
    [[3,'WAVE 1'],[20,'WAVE 2'],[37,'WAVE 3'],[54,'WAVE 4'],[71,'WAVE 5'],[88,"ADHOC's"],[104,'HELPERS'],[120,'DSP']].forEach(([row, value]) => this.set(row, 1, value));
  }
}
...
function testPartialWritePreservesOtherCells() {
  ...
  assert(sheet.get(18, 1) === '11:15 (7)' && sheet.get(35, 1) === '11:20 (9)' && sheet.get(52, 1) === '11:25 (2)' && sheet.get(69, 1) === '11:40 (11)' && sheet.get(86, 1) === '11:45 (8)', 'A filtered partial update must preserve every Wave 1-5 footer label');
