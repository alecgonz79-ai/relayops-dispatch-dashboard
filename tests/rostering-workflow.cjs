...
function run() {
  ...
  assert(context.__padReminderModal.includes('Double check pads')&&(context.__padReminderModal.match(/WAVE [1-5]/g)||[]).length===5&&context.__padAck, 'Morning imports must show all five pad checks and save the required acknowledgement');
