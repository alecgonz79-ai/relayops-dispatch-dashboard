...
function run() {
  ...
  assert(context.__emailTemplateHtml.includes('<strong>Opener:</strong>')&&context.__emailTemplateHtml.includes('<strong>MidShift:</strong>')&&context.__emailTemplateHtml.includes('<strong><u>VTO (2)</u></strong>')&&context.__emailTemplateHtml.includes('<strong><u>VTO (4)</u></strong>'), 'Rich email output must keep the VTO headings bold and underlined');
