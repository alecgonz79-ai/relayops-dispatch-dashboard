...
function run() {
  ...
  assert(context.__padReminderModal.includes('Double check pads')&&(context.__padReminderModal.match(/WAVE [1-6]/g)||[]).length===6&&context.__padAck, 'Morning imports must show all six pad checks and save the required acknowledgement');
